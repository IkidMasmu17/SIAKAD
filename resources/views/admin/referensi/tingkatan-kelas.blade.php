    ...
    <div class="space-y-6">
        ...
        <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-xl shadow-sm animate-fade-in-down">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-bold text-blue-700 uppercase tracking-wide">Perhatian!</h3>
                    <div class="mt-2 text-sm text-blue-600">
                        <p class="mb-1">Isikan tingkatan kelas sesuai dengan jenjang pendidikan sekolah anda.</p>
                        <p>Contoh: <span class="font-bold bg-blue-100 px-2 py-0.5 rounded text-blue-800">X, XI, XII</span>
                            atau <span class="font-bold bg-blue-100 px-2 py-0.5 rounded text-blue-800">10, 11, 12</span></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden animate-fade-in-down">
                <div class="p-6 border-b border-gray-50 flex items-center justify-between bg-siakad-bg/30">
                    <h3 class="text-lg font-bold text-siakad-purple"><i
                            class="fas fa-layer-group mr-2 text-siakad-purple"></i> Form Tingkatan Kelas</h3>
                ...
                <div class="p-8">
                    <form id="form-tingkat">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <!-- Tingkatan Kelas Input -->
                            <div class="space-y-2">
                                <label for="tingkat"
                                    class="block text-xs font-bold text-gray-700 uppercase tracking-widest ml-1">Tingkatan
                                    Kelas</label>
                        ...
                        <table id="order-table" class="w-full text-sm text-left text-gray-500">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50/50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-4 font-bold text-siakad-purple tracking-wider">Tingkatan
                                        Kelas</th>
                                    <th scope="col"
            ...
            $('#form-tingkat').on('submit', function (event) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.errors) {
                            html = data.errors[0];
                            $('#tingkat').addClass('border-red-500 focus:ring-red-500 focus:border-red-500');
                            toastr.error(html);
                        }

                        if (data.success) {
                            toastr.success('Data berhasil disimpan!');
                            $('#tingkat').removeClass('border-red-500 focus:ring-red-500 focus:border-red-500');

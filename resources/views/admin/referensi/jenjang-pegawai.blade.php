            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden animate-fade-in-down">
                <div class="p-6 border-b border-gray-50 flex items-center justify-between bg-siakad-bg/30">
                    <h3 class="text-lg font-bold text-siakad-purple"><i
                            class="fas fa-layer-group mr-2 text-siakad-purple"></i> Form Jenjang Pegawai</h3>
                ...
                <div class="p-8">
                    <form id="form-jenjang">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <!-- Jenjang Pegawai Input -->
                            <div class="space-y-2">
                                <label for="jenjang"
                                    class="block text-xs font-bold text-gray-700 uppercase tracking-widest ml-1">Jenjang
                                    Pegawai</label>
                                <div class="relative group">
                                    ...
                                    <input type="text" name="jenjang" id="jenjang"
                                        ...
                                        placeholder="Contoh: S1, S2, D3, SMA">
                                </div>
                        ...
                        <table id="order-table" class="w-full text-sm text-left text-gray-500">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50/50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-4 font-bold text-siakad-purple tracking-wider">Jenjang
                                        Pegawai</th>
                                    <th scope="col"
            ...
            $('#form-jenjang').on('submit', function (event) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.errors) {
                            html = data.errors[0];
                            $('#jenjang').addClass('border-red-500 focus:ring-red-500 focus:border-red-500');
                            toastr.error(html);
                        }

                        if (data.success) {
                            toastr.success('Data berhasil disimpan!');
                            $('#jenjang').removeClass('border-red-500 focus:ring-red-500 focus:border-red-500');

                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kelas_id" id="jk" class="form-control form-control-sm" disabled>
                                            ...
                                            @foreach($kelas as $obj)
                                                <option value="{{$obj->id}}" {{ $user->kelas == $obj->id ? 'selected' : ''}}>
                                                    {{$obj->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select name="semester" id="jk" class="form-control form-control-sm" required
                                            ...
                                            <option value="ganjil" {{ $user->semester == 'ganjil' ? 'selected' : '' }}>Ganjil
                                            </option>
                                            <option value="genap" {{ $user->semester == 'genap' ? 'selected' : '' }}>Genap
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="tahun_ajaran" id="agama" class="form-control form-control-sm" required
                                            ...
                                            @foreach($tahun_ajaran as $obj)
                                                <option value="{{$obj}}" {{ $obj == $user->tahun_ajaran ? 'selected' : "" }}>
                                                    {{$obj}}</option>
                                            @endforeach
                                        </select>
                                    </div>

            ...
            <ul class="space-y-1">
                ...
                <li x-data="{ open: {{ (request()->is('admin/pelanggaran/*')) ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center space-x-4">
                            <i
                                class="fa fa-exclamation-triangle text-lg group-hover:scale-110 transition-transform"></i>
                ...
                <li x-data="{ open: {{ (request()->is('admin/sekolah/*')) ? 'true' : 'false' }} }">
                    ...
                    <ul x-show="open" x-cloak
                        class="bg-siakad-purple/50 py-2 border-l border-siakad-light-purple/30 ml-8">
                        <li><a href="#"
                                class="block px-6 py-2 text-sm text-siakad-light-purple/70 hover:text-white">Kelas</a>
                        </li>
                        <li><a href="#"
                ...
                <li x-data="{ open: false }">
                    ...
                    <ul x-show="open" x-cloak
                        class="bg-siakad-purple/50 py-2 border-l border-siakad-light-purple/30 ml-8">
                        <li><a href="#!"
                                class="block px-6 py-2 text-sm text-siakad-light-purple/70 hover:text-white">E-Book</a>
                        </li>
                    </ul>
                </li>
            </ul>
